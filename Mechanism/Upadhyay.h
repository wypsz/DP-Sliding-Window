...
class Private_Heavy{
public:
    Private_Heavy(const vector<string>& xw, int w, int sub_num,int step,double epsilon, double gamma, double beta,double zeta,vector<string> dic,int flag,unsigned int initialSeed);
