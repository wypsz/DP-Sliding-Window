    ...
    do
        ...
        do
            ...
            do
                ...
                file_path_1="./results/0.6_1000/output_${run_counter}_1.txt"
                file_path_2="./results/0.6_1000/output_${run_counter}_2.txt"
                file_path_3="./results/0.6_1000/output_${run_counter}_3.txt"
